...
<head>
    <script src="{{ asset('site/dist/js/color-modes.js') }}"></script>
    ...
    <link rel="stylesheet" href="{{ asset('site/dist/css/style-app.css') }}">
    <!-- Favicons -->
...
<body>
    ...
    <script src="{{ asset('site/dist/js/bootstrap.bundle.min.js') }}"
